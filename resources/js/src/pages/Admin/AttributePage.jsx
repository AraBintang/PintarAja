import { Edit2, Plus, Search, Trash2, X, Zap } from 'lucide-react'
...
export default function AdminAttributePage() {
  ...
  const [attributes, setAttributes] = useState([
    ...
    },
    {
      id: 4,
      type: 'Makalah',
      sections: ['Pendahuluan', 'Pembahasan', 'Kesimpulan', 'Daftar Pustaka'],
    },
    {
      id: 5,
            ...
            <table className="w-full min-w-[800px] text-left border-collapse">
              <thead>
                <tr className="bg-gray-50 dark:bg-gray-700 border-b border-gray-100 dark:border-gray-700">
                  <th className="px-6 py-3.5 text-[12px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider w-[80px]">
                    No.
                  </th>
                  <th className="px-6 py-3.5 text-[12px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                    Paper Type
                  </th>
                  <th className="px-6 py-3.5 text-[12px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                    Sections
                  </th>
                  <th className="px-6 py-3.5 text-[12px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider text-right w-[180px]">
                    Action
                  </th>
                </tr>
              </thead>
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {item.sections && item.sections.length > 0 ? (
                          item.sections.map((sec, sIdx) => (
                            <span
                              key={sIdx}
                              className="inline-flex items-center px-2 py-0.5 rounded-md bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 text-[11px] font-medium border border-blue-100 dark:border-blue-900/30"
                            >
                              {sec}
                            </span>
                          ))
