    ...
    <div className="flex-1 h-full bg-[#f7f7f5] dark:bg-[#0f141e] text-gray-600 dark:text-gray-300 overflow-y-auto px-6 pb-6 pt-16 font-sans">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            <h1 className="text-xl font-bold text-gray-800 dark:text-gray-100 flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-xl bg-blue-600 dark:bg-orange-500 flex items-center justify-center shadow-lg shadow-blue-200 dark:shadow-orange-900/30 shrink-0">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 bg-blue-600 dark:bg-orange-500 text-white px-5 py-2.5 rounded-xl font-semibold hover:bg-blue-700 dark:hover:bg-orange-600 transition-all text-sm w-full sm:w-auto"
          >
        ...
        <div className="flex items-center gap-3 mb-6">
          <div className="inline-flex items-center gap-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-1">
            {PERIODS.map((p) => (
              <button
                key={p.key}
        ...
        {/* Note */}
        {/* <div className="mb-6">
          <p className="text-xs text-gray-500 dark:text-gray-400 bg-blue-50/50 dark:bg-orange-900/10 p-3.5 rounded-xl border border-blue-100 dark:border-orange-900/30 flex items-start gap-2">
            <span className="font-bold text-blue-600 dark:text-orange-400 shrink-0">*Note:</span>
                ...
                >
                  ...
                  <div className="absolute -top-3 -right-3 flex items-center gap-2 z-10">
                    <button
                      ...
                      className="w-9 h-9 rounded-full bg-blue-600 dark:bg-orange-500 text-white flex items-center justify-center hover:scale-110 transition-transform shadow-lg"
                      title="Edit Plan"
                    >
                    ...
                    {plan.id !== 1 && (
                      <button
                        ...
                        className="w-9 h-9 rounded-full bg-rose-500 text-white flex items-center justify-center hover:scale-110 transition-transform shadow-lg"
                        title="Delete Plan"
                      >
                  ...
                  {/* CTA */}
                  <div className="mb-6">
                    <button className="w-full py-3 rounded-full font-bold text-sm bg-[#295cce] dark:bg-orange-500 text-white hover:bg-[#1a4baf] dark:hover:bg-orange-600 transition-all shadow-md">
                      Select Plan
                    </button>
                  </div>
                  ...
                  <div className="flex-1">
                    <ul className="space-y-3">
                      {(plan.features ?? []).map((feature, idx) => (
                        <li
                          key={idx}
                          className={`flex items-start gap-3 ${feature.isIncluded === false ? 'opacity-35' : ''}`}
                        >
                          <Sparkles className="w-3.5 h-3.5 text-blue-500 dark:text-orange-400 mt-0.5 flex-shrink-0" />
                          <div>
