...
export default function AIWriterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f7f5] dark:bg-[#0f141e] flex flex-col items-center px-4 py-6 overflow-y-auto transition-colors duration-300">
      {/* Header */}
      <div className="text-center mb-6 max-w-2xl">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-[16px] leading-relaxed">
          Buat karya tulis ilmiah berkualitas tinggi dengan bantuan AI. Pilih jenis karya, bahasa,
          dan model AI favorit Anda.
        </p>
      </div>
      ...
      <div className="w-full max-w-3xl">
        ...
        {isGenerated && (
          <button
            ...
            className="w-full flex items-center justify-between px-5 py-3 mb-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl text-[13px] font-semibold text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
          >
        ...
        <div
          className={`transition-all duration-300 ease-in-out overflow-hidden ${inputCollapsed ? 'max-h-0 opacity-0' : 'max-h-[2000px] opacity-100'}`}
        >
          {/* Topic Textarea */}
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-sm overflow-hidden mb-4">
            <div className="p-5">
              <div className="flex items-center justify-between mb-3">
                <label className="text-[13px] font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">
                  Topik Penelitian
                </label>
                <button
                  type="button"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
            ...
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-4">
              <label className="text-[11px] font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-2 block">
                Jenis Karya Tulis
              </label>
                  ...
                  <SelectGroup>
                    ...
                    {LANGUAGES.map((lang) => (
                      <SelectItem
                        key={lang.text}
                        value={lang.text}
                        className="cursor-pointer py-2.5 px-3 hover:bg-blue-50 focus:bg-blue-50 dark:hover:bg-gray-700 dark:focus:bg-gray-700 transition-colors rounded-lg mx-1 my-0.5"
                      >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <button
              ...
              className="relative group px-8 py-4 bg-[#2686D4] dark:bg-[#F2901E] text-white text-[15px] font-bold rounded-2xl shadow-[0_4px_20px_rgba(74,144,217,0.25)] hover:shadow-[0_4px_28px_rgba(74,144,217,0.4)] transition-all hover:scale-[1.02] overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] font-medium text-[#4A90D9] bg-[#4A90D9]/10 px-2 py-0.5 rounded-md">
                  {bagian}
                </span>
              </div>
              <div className="flex items-center gap-2">
              ...
              {exampleCards.map((card, i) => (
                ...
                >
                  <p className="text-[13px] text-gray-400 mb-1 flex items-center gap-1.5">
                    <span className="text-[#4A90D9] font-bold text-[11px] bg-[#4A90D9]/10 px-2 py-0.5 rounded-md">
                      Contoh
                    </span>
                  </p>
