      ...
      setTranscriptionResult({
        ...
        transcript: [
          ...
          { speaker: 'Singer', time: '02:02', text: 'Kupastikan kita bahagia lagi.' },
          {
            speaker: 'Singer',
            time: '02:04',
            text: 'Sampai ku temukan caraku untuk lupakanmu pergi.',
          },
          ...
          { speaker: 'Singer', time: '02:14', text: 'Sampai pada palung kecewa.' },
          {
            speaker: 'Singer',
            time: '02:16',
            text: 'Bila pada akhirnya kita menjadi asing pada kata bahagia.',
          },
    ...
    <div className="min-h-screen bg-[#f7f7f5] dark:bg-[#0f141e] flex flex-col items-center justify-center px-4">
      ...
      {transcriptionResult ? (
            ...
            <div className="w-full md:w-1/3 p-6 sm:p-8 bg-gray-50/50 dark:bg-gray-800/50 border-b md:border-b-0 md:border-r border-gray-100 dark:border-gray-700">
              ...
              <div className="flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400 mb-6 font-medium">
                <span className="flex items-center gap-1.5">
                  <Mic className="w-4 h-4" /> {transcriptionResult.speakers} Speakers
                </span>
                <span>•</span>
                ...
                {transcriptionResult.transcript.map((item, idx) => (
                  <div key={idx} className="flex flex-col sm:flex-row gap-2 sm:gap-4 group">
                    <div className="sm:w-20 flex-shrink-0 flex items-center gap-2 sm:justify-start">
                      <span className="text-[12px] font-mono text-gray-400 dark:text-gray-500 bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded-md">
                        {item.time}
                      </span>
                    </div>
                    <div className="flex-1">
                      <span
                        className={`text-[13px] font-bold mb-1 block ${item.speaker === 'Speaker 1' ? 'text-blue-600 dark:text-blue-400' : 'text-purple-600 dark:text-purple-400'}`}
                      >
                        {item.speaker}
                      </span>
        ...
        <div className="flex flex-col items-center justify-center max-w-md w-full py-12">
          ...
          <p className="text-[#4A90D9] font-bold text-3xl mb-4 tracking-tight drop-shadow-sm">
            {processingProgress}%
          </p>
        ...
        <div className="flex flex-col items-center max-w-md w-full">
          ...
          <button
            onClick={handleReset}
            className="mt-4 text-[13px] text-gray-500 dark:text-gray-400 hover:text-gray-800 font-medium transition-colors flex items-center gap-1.5 px-4 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600"
          >
        ...
        <div className="w-full max-w-4xl px-4">
              ...
              <div className="flex flex-col items-center gap-3">
                <div className="flex flex-col items-center">
                  ...
                  {(isRecording || isPaused) && (
                    <span
                      className={`text-[11px] mt-1 font-mono uppercase tracking-[0.2em] ${isPaused ? 'text-orange-500' : 'text-red-500 animate-pulse'}`}
                    >
          ...
          {!isRecording && !isPaused && (
            <div className="mt-8 flex justify-center">
              <button
                onClick={handleReset}
                className="text-[13px] text-gray-500 dark:text-gray-400 hover:text-gray-800 font-medium transition-colors flex items-center gap-1.5 px-4 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600"
              >
