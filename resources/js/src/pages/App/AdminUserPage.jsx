...
import { Users, UserPlus, Search, Plus, Crown, UserCheck, UserX, Shield, Edit2, Trash2, MoreHorizontal, Filter, ChevronLeft, ChevronRight, X } from 'lucide-react';
import {
    Select,
    SelectContent,
    SelectGroup,
...
const MOCK_USERS = [
    { id: 1, name: 'Ubaidillah', email: 'ubaid.namaku@gmail.com', role: 'Admin', plan: 'Premium Plan', status: 'Active', quota: 'Unlimited', joinDate: '12 Jan 2025' },
    { id: 2, name: 'Heri Suryawan', email: 'heriabunizar@gmail.com', role: 'Admin', plan: 'Free Account', status: 'Active', quota: 'Unlimited', joinDate: '08 Feb 2025' },
    { id: 3, name: "Muhammad Nas'al", email: 'aveyound@gmail.com', role: 'Admin', plan: 'Free Account', status: 'Active', quota: '0', joinDate: '15 Feb 2025' },
    { id: 4, name: 'REZA SETYAWAN', email: 'reza84138@smk.belajar.id', role: 'User', plan: 'Premium Plan', status: 'Active', quota: 'Unlimited', joinDate: '20 Feb 2025' },
    { id: 5, name: 'rafha arya', email: 'wicaksonorafha@gmail.com', role: 'User', plan: 'Free Account', status: 'Active', quota: 'Unlimited', joinDate: '22 Feb 2025' },
    { id: 6, name: 'It Jumpwin', email: 'itjumpwin@gmail.com', role: 'User', plan: 'Free Account', status: 'Inactive', quota: 'Unlimited', joinDate: '25 Feb 2025' },
    { id: 7, name: 'accounting jumpwin', email: 'jumpwin.accnt@gmail.com', role: 'User', plan: 'Free Account', status: 'Active', quota: 'Unlimited', joinDate: '28 Feb 2025' },
    { id: 8, name: 'APSARI DEONITA TEYN', email: 'shariteyn@gmail.com', role: 'User', plan: 'Premium Plan', status: 'Active', quota: 'Unlimited', joinDate: '01 Mar 2025' },
    { id: 9, name: "THORIQ Dhiyaa'", email: 'jellyheadjelly@gmail.com', role: 'User', plan: 'Free Account', status: 'Inactive', quota: 'Unlimited', joinDate: '02 Mar 2025' },
    { id: 10, name: 'Acied Rasyid', email: 'acied.ilove@gmail.com', role: 'User', plan: 'Free Account', status: 'Active', quota: 'Unlimited', joinDate: '03 Mar 2025' },
];
...
export default function AdminUserPage() {
    ...
    const [formData, setFormData] = useState({ name: '', email: '', password: '', status: '', plan: '', role: '' });
    ...
    const stats = [
        { label: 'Total Users', value: totalUsers, icon: Users, color: 'from-blue-500 to-blue-600', bgLight: 'bg-blue-50', textColor: 'text-blue-600' },
        { label: 'Active Users', value: `${activeUsers}/${MOCK_USERS.length}`, icon: UserCheck, color: 'from-emerald-500 to-teal-500', bgLight: 'bg-emerald-50', textColor: 'text-emerald-600' },
        { label: 'Admin', value: adminUsers, icon: Shield, color: 'from-blue-400 to-blue-600', bgLight: 'bg-blue-50', textColor: 'text-blue-600' },
        { label: 'Premium', value: premiumUsers, icon: Crown, color: 'from-blue-500 to-blue-700', bgLight: 'bg-blue-50', textColor: 'text-blue-600' },
    ];
            ...
            <div className="max-w-[1200px] mx-auto overflow-hidden">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-5 sm:mb-6">
                    <div>
                        ...
                        <p className="text-gray-500 dark:text-gray-400 text-[12px] sm:text-sm mt-1 sm:ml-[46px]">Kelola data pengguna, langganan, dan status akun</p>
                    </div>
                    <button
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 mb-5 sm:mb-6 w-full">
                    {stats.map((stat) => (
                        <div key={stat.label} className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-3 sm:p-5 border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow group min-w-0">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden">
                        ...
                        <table className="w-full min-w-[900px] text-left border-separate border-spacing-0">
                            <thead>
                                <tr className="bg-gray-50 dark:bg-gray-700 border-b border-gray-100 dark:border-gray-700">
                                    ...
                                    <th className="px-6 py-4 text-[12px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">User Info</th>
                                    <th className="px-6 py-4 text-[12px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Subscription</th>
                                    ...
                                    <tr key={user.id} className="hover:bg-violet-50/30 transition-colors group">
                                        ...
                                        <td className="px-4 py-3.5">
                                            <div className="flex items-center gap-3">
                                                <div className={`w-9 h-9 rounded-full ${getAvatarColor(user.name)} flex items-center justify-center text-white text-[12px] font-bold shadow-sm flex-shrink-0`}>
                                                    {getInitials(user.name)}
                                                </div>
                                                <div className="min-w-0">
                                                    <p className="text-[14px] font-semibold text-gray-800 dark:text-gray-100 truncate">{user.name}</p>
                                        ...
                                        <td className="px-4 py-3.5">
                                            {user.plan === 'Premium Plan' ? (
                                                ...
                                                <span className="text-[13px] font-medium text-gray-500 dark:text-gray-400">Free</span>
                                            )}
                                        </td>
                                        <td className="px-6 py-4 text-center">
                                            <span className={`px-2.5 py-1 rounded-full text-[11px] font-bold uppercase tracking-wider border ${user.status === 'Active'
                                        ...
                                        <td className="px-4 py-3.5">
                                            <div className="flex items-center justify-end gap-1.5 transition-opacity">
                                                ...
                                                <button title="Delete" className="w-8 h-8 rounded-lg bg-red-50 hover:bg-red-100 flex items-center justify-center text-red-500 transition-colors">
                    ...
                    <div className="px-6 py-4 border-t border-gray-100 dark:border-gray-700 flex items-center justify-between">
                        <p className="text-[13px] text-gray-500 dark:text-gray-400">
                            Menampilkan <span className="font-semibold text-gray-800 dark:text-gray-100">1-10</span> dari <span className="font-semibold text-gray-800 dark:text-gray-100">713</span> user
                        </p>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/40 dark:bg-black/60 backdrop-blur-sm">
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden border border-gray-100 dark:border-gray-700 flex flex-col">
                        ...
                        <div className="p-6 overflow-y-auto max-h-[70vh]">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div className="space-y-2 col-span-1 md:col-span-2">
                                    <label className="text-[13px] font-semibold text-gray-600 dark:text-gray-300 block">Full Name</label>
                                    <input
                                        type="text"
                                        value={formData.name}
                                ...
                                {/* E-mail */}
                                <div className="space-y-2 col-span-1 md:col-span-2">
                                    <label className="text-[13px] font-semibold text-gray-600 dark:text-gray-300 block">Email Address</label>
                                    <input
                                        type="email"
                                ...
                                <div className="space-y-2 col-span-1 md:col-span-2 mb-2">
                                    <label className="text-[13px] font-semibold text-gray-600 dark:text-gray-300 block">Password</label>
                                    <input
                                        type="password"
                                ...
                                <div className="space-y-2">
                                    <label className="text-[13px] font-semibold text-gray-600 dark:text-gray-300 block">Active Status</label>
                                ...
                                {/* Plan */}
                                <div className="space-y-2">
                                    <label className="text-[13px] font-semibold text-gray-600 dark:text-gray-300 block">Subscription Plan</label>
                                ...
                                {/* Role */}
                                <div className="space-y-2">
                                    <label className="text-[13px] font-semibold text-gray-600 dark:text-gray-300 block">Role</label>
                        ...
                        <div className="px-6 py-4 bg-gray-50 dark:bg-gray-700 border-t border-gray-100 dark:border-gray-700 flex justify-end gap-3">
                            ...
                            <button onClick={() => setIsAddModalOpen(false)} className="px-6 py-2.5 text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 rounded-xl shadow-sm hover:shadow-md hover:shadow-blue-200 dark:hover:shadow-none transition-all uppercase tracking-wide">
                                Simpan
                            </button>
                        </div>
                    </div>
