        ...
        <div className="max-w-2xl">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
              Undang teman dan dapatkan hadiah menarik
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-dashed border-gray-300 dark:border-gray-700 p-10 text-center">
            ...
            <button
              ...
              disabled={activating}
              className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 disabled:opacity-60 text-white font-bold text-sm transition-all active:scale-95"
            >
              {activating ? (
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-emerald-600 dark:text-emerald-400 mt-0.5">
                  7 teman sudah bergabung menggunakan kode referralmu. Klik tombol di bawah untuk
                  mengaktifkan.
                </p>
              </div>
            </div>
            ...
            {Array.from({ length: 7 }).map((_, i) => {
              ...
              return (
                <div key={i} className="flex-1 flex flex-col items-center gap-1">
                  {isLast && <span className="text-[9px] font-bold text-emerald-500">FREE</span>}
                  <div
