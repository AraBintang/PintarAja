...
import { ArrowUp, Video as VideoIcon, Plus, X as XIcon, Download, Sparkles, Zap, Check } from 'lucide-react'
...
const IMAGE_MODELS = [
    ...
    { 
        ...
        icon: <VideoIcon className="w-4 h-4 text-gray-300" />
    },
    { 
        id: 'anime', 
        name: 'Anime',
...
export default function VideoGenerator() {
    ...
    const generateImage = async (e) => {
        ...
        try {
            ...
            const response = await request('/generate-video', {
                method: 'POST',
                body: formData
            })
            ...
            <div className="flex-1 overflow-y-auto pt-8 md:pt-12 px-6 pb-44 flex flex-col items-center">
                ...
                {!videoUrl && !loading && (
                    <div className="mt-20 max-w-2xl text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">AI Video Generator</h1>
                        <p className="text-gray-500 dark:text-gray-400 text-[15px] leading-relaxed">
                            Pilih model di menu bawah, ketikkan imajinasi Anda, dan biarkan AI menganimasikannya. <br/>
                ...
                {loading && (
                    <div className="mt-20 flex flex-col items-center justify-center animate-pulse">
                        ...
                        <p className="text-gray-500 font-medium">Sedang menganimasikan imajinasi Anda... (10-30 detik)</p>
                    </div>
                )}
                ...
                {videoUrl && !loading && (
                    <div className="w-full max-w-3xl mt-4 p-4 md:p-8 bg-white dark:bg-gray-800 rounded-3xl border border-gray-200/60 dark:border-gray-700/50 flex flex-col items-center shadow-sm animate-in fade-in zoom-in-95 duration-500">
                        <div className="w-full relative group rounded-2xl overflow-hidden bg-gray-100 dark:bg-gray-900">
                            <video src={videoUrl} controls className="w-full h-auto object-contain" />
                        </div>
                        <div className="w-full mt-6 flex justify-between items-center">
                            <div className="flex-1" />
                            <a
                                href={videoUrl}
                                download={`ai-video-${Date.now()}.png`}
                                target="_blank"
                                rel="noreferrer"
                ...
                <div className="max-w-3xl md:mx-auto w-full bg-[#f7f7f5] dark:bg-[#0f141e] rounded-t-4xl">
                    ...
                    <div className="py-2 text-center">
                        <p className="text-[11px] text-gray-400 dark:text-gray-500">
                            Pintaraja AI Video Generator memproses gambar dalam hitungan detik.
                        </p>
                    </div>
                </div>
            </div>
