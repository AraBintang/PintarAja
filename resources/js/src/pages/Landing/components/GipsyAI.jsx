    ...
    },
    {
        ...
        icon: (
            <svg width="36" height="36" viewBox="0 0 24 24" fill="none">
                ...
                <line x1="12" y1="2" x2="12" y2="6" stroke="#E8607A" strokeWidth="2" strokeLinecap="round" />
                <line x1="12" y1="18" x2="12" y2="22" stroke="#E8607A" strokeWidth="2" strokeLinecap="round" />
                <line x1="4.93" y1="4.93" x2="7.76" y2="7.76" stroke="#E8607A" strokeWidth="2" strokeLinecap="round" />
                <line x1="16.24" y1="16.24" x2="19.07" y2="19.07" stroke="#E8607A" strokeWidth="2" strokeLinecap="round" />
                <line x1="2" y1="12" x2="6" y2="12" stroke="#E8607A" strokeWidth="2" strokeLinecap="round" />
                <line x1="18" y1="12" x2="22" y2="12" stroke="#E8607A" strokeWidth="2" strokeLinecap="round" />
                <line x1="4.93" y1="19.07" x2="7.76" y2="16.24" stroke="#E8607A" strokeWidth="2" strokeLinecap="round" />
                <line x1="16.24" y1="7.76" x2="19.07" y2="4.93" stroke="#E8607A" strokeWidth="2" strokeLinecap="round" />
            </svg>
        ),
    },
    {
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-[17px] max-w-3xl mx-auto leading-relaxed">
                        Nikmati fitur dan hasil yang beragam dari berbagai tool yang telah kami integrasikan untuk kemudahan dan efisiensi kerja Anda.
                    </p>
                </div>
                    ...
                    {tools.map((tool, i) => (
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-[18px] font-bold text-[#0a192f] dark:text-white mb-3 group-hover:text-[#4A90D9] transition-colors">{tool.name}</h3>
                                <p className="text-gray-500 dark:text-gray-400 text-[14px] leading-relaxed group-hover:text-gray-600 transition-colors">{tool.desc}</p>
                            </div>
                        </div>
                    ))}
                </div>
