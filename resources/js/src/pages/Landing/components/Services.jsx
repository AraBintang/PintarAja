                  ...
                  >
                    <div className="p-5 pt-0 pr-12">
                      ...
                      <div className="flex gap-3">
                        <a
                          href="#"
                          className="px-5 py-2 text-[13px] font-semibold text-[#4A90D9] bg-[#4A90D9]/10 rounded-full hover:bg-[#4A90D9]/20 transition-colors"
                        >
                          Lihat Selengkapnya
                        </a>
                        <a
                          href="#kontak"
                          className="px-5 py-2 text-[13px] font-semibold text-white bg-[#4A90D9] rounded-full hover:bg-[#3A7BC8] transition-colors shadow-sm hover:shadow-md"
                        >
                          Pesan Sekarang
                        </a>
                      </div>
