    ...
    <section id="tentang-kami" className="py-32 bg-[#001a1a] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center gap-20">
        ...
        <div className="flex-1">
          <h2 className="text-sm font-bold text-[#00ffcc] uppercase tracking-[0.3em] mb-4">
            Visi Kami
          </h2>
          <h3 className="text-4xl md:text-5xl font-extrabold text-white mb-8 leading-tight">
            Membangun Masa Depan Riset yang Terpersonalisasi
          </h3>
          <p className="text-slate-400 text-lg leading-relaxed mb-10">
            Pintaraja didirikan dengan misi untuk menjembatani kesenjangan antara ambisi penelitian
            dan eksekusi teknis. Kami percaya bahwa setiap riset berhak mendapatkan dukungan terbaik
            untuk memberikan dampak yang nyata bagi dunia pendidikan dan bisnis.
          </p>
