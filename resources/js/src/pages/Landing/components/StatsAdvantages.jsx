const features = [
  {
    ...
    title:
      'Generate dokumen dengan customisasi luas dan sempurna menggunakan template prompt yang siap pakai.',
    color: '#F5A623',
  },
  {
    icon: (
    ...
    title:
      'Diskusi dengan AI canggih yang sudah di-set sesuai role-nya dan mampu membaca serta memahami dokumen.',
    color: '#E8607A',
  },
  {
    icon: (
  ...
  },
  {
    ...
    title:
      'Tersedia berbagai paket dengan harga terjangkau untuk pelajar, mahasiswa, hingga profesional.',
    color: '#4ADE80',
  },
  {
    icon: (
    ...
    title:
      'Mendukung input teks, gambar, dan dokumen untuk menghasilkan respons yang lebih kaya dan fleksibel.',
    color: '#60A5FA',
  },
  {
    icon: (
...
export default function StatsAdvantages() {
  return (
    <section id="keunggulan" className="relative py-24 bg-white dark:bg-gray-900 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          {/* Left - Info Card */}
          <div className="bg-gradient-to-br from-[#f0f4ff] to-[#f5f0ff] dark:from-gray-800 dark:to-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 p-10 relative overflow-hidden shadow-sm">
          ...
          <div className="space-y-4">
            {features.map((feature, i) => (
              ...
              >
                ...
                <p className="text-gray-600 text-[14.5px] leading-relaxed group-hover:text-[#0a192f] dark:text-white transition-colors">
                  {feature.title}
                </p>
              </div>
            ))}
