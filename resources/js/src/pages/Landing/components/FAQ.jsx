...
const faqs = [
    ...
    },
    {
        ...
        a: 'Pintaraja menyediakan jasa olah data statistik, konsultasi riset, kelas online, dan AI tools penunjang riset.',
    },
    {
        q: 'Bagaimana cara melakukan pemesanan produk atau jasa dari Pintaraja?',
        a: 'Anda bisa langsung menghubungi kami melalui tombol "Kontak Kami" atau mengisi formulir yang tersedia di website.',
    },
    {
        q: 'Bagaimana mekanisme pembayaran produk atau jasa dari Pintaraja?',
        a: 'Pembayaran dapat dilakukan melalui transfer bank. DP minimal hanya 10% dari total biaya.',
    },
    {
...
export default function FAQ() {
    ...
    return (
        <section id="faq" className="py-24 bg-[#f4f7fb] dark:bg-gray-900 border-t border-gray-100 dark:border-gray-700 relative overflow-hidden">
            {/* Ambient glows */}
            ...
            <div className="max-w-3xl mx-auto px-6 relative z-10">
                ...
                <div className="space-y-4">
                    {faqs.map((faq, index) => (
                        <div
                            key={index}
                            className={`bg-white dark:bg-gray-800 rounded-2xl border transition-all duration-300 overflow-hidden ${openIndex === index
