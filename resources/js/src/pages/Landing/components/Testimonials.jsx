...
export default function Testimonials() {
    return (
        <section id="testimoni" className="relative py-28 bg-[#f4f7fb] dark:bg-gray-900 overflow-hidden">
            {/* Ambient glows */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-12 items-start">
                    ...
                    <div className="sticky top-32 pt-8">
                        ...
                        <h2 className="text-3xl md:text-[40px] font-extrabold text-[#0a192f] dark:text-white leading-[1.2] mb-6">
                            ...
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4A90D9] to-[#6AB0F3]">Telah Terbantu</span>
                        </h2>
                        <p className="text-gray-500 mb-8 max-w-sm">Ratusan klien telah memberikan ulasan positif terhadap layanan kami.</p>
                        <Link
                            to="/register"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-8">
                        {reviews.map((review, i) => (
                            ...
                            >
                                ...
                                <Stars />
                                <h4 className="text-[#0a192f] dark:text-white font-bold text-[16px] mb-3 leading-snug">{review.title}</h4>
                                <p className="text-gray-500 dark:text-gray-400 text-[14px] leading-relaxed mb-6 flex-grow">{review.text}</p>
                                ...
                                <div className="flex items-center gap-3 pt-4 border-t border-gray-100 dark:border-gray-700 mt-auto">
                                    ...
                                    <div>
                                        <p className="text-[#0a192f] dark:text-white text-[13px] font-bold group-hover:text-[#4A90D9] transition-colors">{review.name}</p>
