...
export const PlanProvider = ({ children }) => {
    ...
    const defaultPlans = [
        {
            id: 1,
            name: 'Google AI Plus',
            description: 'Dapatkan akses lebih tinggi ke fitur baru dan canggih untuk meningkatkan produktivitas dan kreativitas',
        ...
        },
        {
            ...
            description: 'Dapatkan akses tingkat tertinggi ke kemampuan terbaik AI Google dan fitur eksklusif',
            ...
            try {
                ...
                return parsed.map((p, idx) => ({
                    ...
                    features: p.features.map((f, fIdx) => ({
                        ...f,
                        icon: defaultPlans[idx]?.features[fIdx]?.icon || <Sparkles className="w-5 h-5 text-gray-700" />
                    }))
                }));
            } catch (e) {
    ...
    return (
        <PlanContext.Provider value={{ plans, updatePlan }}>
            {children}
