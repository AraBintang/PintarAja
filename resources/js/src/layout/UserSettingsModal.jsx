        ...
        <div className="w-full md:w-[260px] flex md:flex-col border-b md:border-b-0 md:border-r border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50 overflow-x-auto md:overflow-y-auto">
          ...
          <div className="flex md:flex-col flex-1 px-4 py-2 space-x-2 md:space-x-0 md:space-y-1 whitespace-nowrap overflow-x-auto md:overflow-x-hidden no-scrollbar">
            <button
              ...
              className={`flex-shrink-0 md:w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-[14px] font-medium transition-all ${
                activeTab === 'Profil'
          ...
          <div className="hidden md:block p-5 border-t border-gray-200 dark:border-gray-700">
            <p className="text-[12px] text-gray-500 dark:text-gray-400 mb-3 font-medium tracking-wide">
              Switch account
            </p>
            <div className="flex items-center gap-3">
            ...
            {activeTab === 'Profil' && (
              <div className="max-w-md mx-auto md:mx-0 space-y-6 md:space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
                ...
                <div className="space-y-2 text-left">
                  <h4 className="text-[13px] md:text-[14px] font-medium text-gray-500 dark:text-gray-400">
                    Account Name
                  </h4>
                  {isEditingProfile ? (
                    <input
                    ...
                    <p className="text-[15px] md:text-[16px] text-gray-900 dark:text-white bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-2.5 md:py-3 font-medium">
                      {userName}
                    </p>
                  )}
                </div>
                  ...
                  {!isChangingPassword ? (
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl gap-3">
                      <div className="flex flex-col gap-0.5">
                        ...
                        <p className="text-[12px] md:text-[13px] text-gray-500 dark:text-gray-400">
                    ...
                    <div className="p-4 md:p-5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl space-y-4 md:space-y-5 animate-in fade-in slide-in-from-top-2 duration-300">
                      ...
                      <div className="space-y-4">
                        <div className="space-y-1.5">
                          <label className="text-[12px] md:text-[13px] font-medium text-gray-700 dark:text-gray-300">
                            Password Lama
                          </label>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-2 mt-2">
                          {passwordRequirements.map((req) => {
                            ...
                            return (
                              <div
                                key={req.id}
                                className={`flex items-center gap-2 text-[11px] md:text-[12px] font-medium transition-colors ${isValid ? 'text-green-600 dark:text-green-400' : 'text-gray-500'}`}
                              >
                                {isValid ? (
                      ...
                      <div className="flex items-center justify-end gap-3 pt-6 border-t border-gray-100 dark:border-gray-700">
                        <button
                          ...
                          className="px-4 py-2 text-[13px] font-medium text-gray-500"
                        >
                          Batal
                        </button>
                        <button
            ...
            {activeTab === 'Subscription' && (
              <div className="animate-in fade-in slide-in-from-bottom-2 duration-500 max-w-xl mx-auto py-2 md:py-4">
                ...
                <div className="text-center mb-6 md:mb-10">
                  <h2 className="text-[24px] md:text-[32px] font-bold text-gray-900 dark:text-white mb-1 md:mb-2">
                    Premium Plan
                  </h2>
                  <p className="text-gray-500 dark:text-gray-400 font-medium text-[14px] md:text-[16px]">
                    Billed weekly at{' '}
                    <span className="text-gray-900 dark:text-white font-bold">Rp10.000</span>
                  </p>
                </div>
                ...
                <div className="space-y-6 md:space-y-8 mb-8 md:mb-12">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-end">
                      <span className="text-[12px] md:text-[14px] font-bold text-gray-400 uppercase tracking-widest">
                        Sisa Masa Aktif
                      </span>
                      <span className="text-[14px] md:text-[16px] font-bold text-gray-900 dark:text-white">
                        5 dari 7 Hari
                      </span>
                    </div>
                  ...
                  <div className="divide-y divide-gray-100 dark:divide-gray-800 border-t border-b border-gray-100 dark:border-gray-800">
                    <div className="py-4 flex justify-between items-center">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-[13px] md:text-[14px] text-gray-600 dark:text-gray-400 font-medium">
                          Berakhir Pada
                        </span>
                      </div>
                      <span className="text-[13px] md:text-[14px] font-bold text-gray-900 dark:text-white">
                        10 Maret 2026
                      </span>
                    </div>
                  </div>
                ...
                <div className="bg-gray-50/80 dark:bg-gray-800/80 rounded-2xl p-4 md:p-6 border border-gray-100 dark:border-gray-700">
                  <label className="block text-[13px] md:text-[14px] font-bold text-gray-900 dark:text-white mb-3 md:mb-4">
                    Punya Kode Redeem?
                  </label>
