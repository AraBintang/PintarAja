      ...
      if (initialData) {
        ...
        setFormData({
          ...
          published_at: initialData.published_at
            ? new Date(initialData.published_at).toLocaleDateString('en-CA')
            : '',
        })
      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-4xl overflow-hidden flex flex-col max-h-[90vh]"
          >
            {/* Header */}
                  ...
                  {formData.slug && (
                    <p className="text-[12px] text-gray-400 dark:text-gray-500 truncate">
                      <span className="text-gray-600 dark:text-gray-400">
                        Preview: {window.location.origin}/blog/
                      </span>
                      <span className="text-blue-500 dark:text-orange-400 font-medium">
                        {formData.slug}
                      </span>
                    </p>
                  )}
