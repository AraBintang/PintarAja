...
import {
    ...
    Heading1, Heading2, Heading3, Quote, Minus, Undo2, Redo2,
    Code, Pilcrow, RemoveFormatting
} from 'lucide-react';
...
export default function TiptapEditor({ content = '', onUpdate, placeholder = 'Hasil AI akan muncul di sini...' }) {
    const editor = useEditor({
        ...
        editorProps: {
            attributes: {
                class: 'tiptap-editor-content outline-none min-h-[300px] px-5 py-4 text-[15px] leading-relaxed text-gray-700 dark:text-gray-200 prose prose-sm dark:prose-invert max-w-none',
            },
        },
        onUpdate: ({ editor }) => {
