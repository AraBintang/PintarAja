...
<section class="max-w-5xl mx-auto px-6 sm:px-10 pt-16 pb-12 md:pt-24 md:pb-16">
    <div class="max-w-2xl">
        <p class="text-xs font-semibold uppercase tracking-widest text-blue-600 dark:text-orange-400 mb-5">
            Blog &amp; Insights
        </p>
        <h1 class="text-4xl sm:text-5xl leading-tight text-gray-900 dark:text-gray-100 mb-5">
            Artikel terbaru<br>dari Pintaraja
        </h1>
        <p class="text-base text-gray-500 dark:text-gray-400 leading-relaxed max-w-lg">
            Temukan tips produktivitas, panduan AI, dan wawasan teknologi untuk memaksimalkan cara kamu belajar dan bekerja.
        </p>
    </div>
</section>
...
<section class="max-w-5xl mx-auto px-6 sm:px-10 pb-20">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
            ...
            <div class="flex flex-col flex-1 p-6">
                ...
                <div class="flex items-center gap-2 mb-3">
                    ...
                    <a href="/blog/category/{{ urlencode($blog->M_BlogCategory) }}"
                       class="text-xs font-semibold uppercase tracking-wider text-blue-600 dark:text-orange-400 hover:opacity-70 transition-opacity">
                        {{ $blog->M_BlogCategory }}
                    </a>
        ...
        <div class="col-span-3 py-24 text-center">
            ...
            <p class="text-sm text-gray-400 dark:text-gray-600">Silakan cek kembali nanti.</p>
        </div>
        @endforelse
    </div>
